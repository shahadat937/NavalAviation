...
export class SearchingComponent implements OnInit {
  ...
  getPartNoByDepartmentNameId(id: number) {
    this.ItemDetailService.getPartNoForSparesByDepartmentNameId(id,this.masterData.sparescategory.tools).subscribe((res) => {
  ...
  getSelectedTraineeByPno(pno) {
    var departmentNameId = this.SearchForm.value["departmentNameId"];
    this.ItemDetailService.getSelectedPartNoForSpareParameterRequest(pno,departmentNameId,this.masterData.sparescategory.tools).subscribe(
      (response) => {
