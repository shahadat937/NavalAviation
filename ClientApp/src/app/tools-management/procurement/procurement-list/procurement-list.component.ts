...
export class ProcurementListComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'ser', 'itemDetail','itemName','tenderNumber', 'dateOfTenderFloat', 'qty','actions'];
  ...
  getProcurements() {
    this.isLoading = true;
    this.ProcurementService.getProcurements(this.paging.pageIndex, this.paging.pageSize,this.searchText,this.masterData.sparescategory.tools).subscribe(response => {
