...
@Component({
  selector: 'app-sailorbiodata',
  templateUrl: './sailorbiodata-list.component.html',
  styleUrls: ['./sailorbiodata-list.component.sass']
})
export class SailorBioDataListComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'ser', 'pno', 'rankId','name','dateOfJoin', 'courseId','duties', 'aviationCategory','departmentNameId','mobile', 'email', 'actions'];
