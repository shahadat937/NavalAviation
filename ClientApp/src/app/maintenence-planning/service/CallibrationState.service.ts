...
export class CallibrationStateService {
  ...
  getCalibrationStateForSpare(departmentNameId){
    return this.http.get<any[]>(this.baseUrl + '/maintenence-state/get-maintenenceStateForSpareSpRequest?departmentNameId='+departmentNameId+'')
  }
  
  getMaintenenceStateListForSearch(searchText,departmentNameId){
    return this.http.get<any[]>(this.baseUrl + '/maintenence-state/get-maintenenceStateListForSearch?departmentNameId='+departmentNameId+'&searchText='+searchText+'')
  }
  ...
  saveMaintenenceState(model: any) {
    return this.http.post(this.baseUrl + '/maintenence-state/save-maintenenceState', model);
  } 
  delete(id:number){
