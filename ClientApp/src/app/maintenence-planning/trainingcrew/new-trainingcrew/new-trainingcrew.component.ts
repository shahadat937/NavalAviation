...
export class NewTrainingCrewComponent implements OnInit {
  ...
  displayedColumns: string[] = ['ser',  'rankRemarks', 'duties','mobile', 'officersStatus', 'actions'];
  paging = {
  ...
  ngOnInit(): void {
    ...
    if (id) {
      this.pageTitle = 'Edit Officer Biodata';
      ...
      this.pageTitle = 'Create Officer Biodata';
  ...
  intitializeForm() {
    this.TrainingCrewForm = this.fb.group({
      ...
      courseId: [],
      departmentNameId: [],
      officersStatusId: [this.masterData.officerStatus.Present],
      rankId:[],
      pno: [''],
      name: [''],
      dateOfJoin: [''],
  ...
  onDepartmentNameSelectionChange(){
    ...
    if(departmentId) {
      ...
      this.TrainingCrewService.getTrainingCrewListByDepartmentNameId(this.searchText,departmentId,1).subscribe(res=>{
        this.trainingCrewList=res
        console.log( "trainingCrewList");
              ...
              body{  width: 99%;}
                ...
                table, td, th {
                      ...
                      font-size: 13px;
                        ...
                        .table.table.tbl-by-group.db-li-s-in tr .cl-action-of{
                          display: none;
                        }
      ...
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(result => {
        ...
        if (result) {
          this.TrainingCrewService.update(+id,this.TrainingCrewForm.value).subscribe(response => {
            this.router.navigateByUrl('/biodata/add-trainingcrew');
