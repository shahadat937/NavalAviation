...
@Component({
  selector: 'app-maintainencestateview',
  templateUrl: './maintainencestateview-list.component.html',
  styleUrls: ['./maintainencestateview-list.component.sass']
})

export class MaintainenceStateViewListComponent implements OnInit {
  ...
  //   this.isLoading = true;
  //   this.CallibrationStateService.getCalibrationStateForSpare(departmentNameId).subscribe(res => {
