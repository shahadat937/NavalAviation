...
export class NewDailyAirworthinessFromCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (id) {
      this.pageTitle = 'Edit Daily Airworthiness From Category';
      ...
      this.pageTitle = 'Create Daily Airworthiness From Category';
      ...
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(result => {
        ...
        if (result) {
          this.DailyAirworthinessFromCategoryService.update(+id,this.DailyAirworthinessFromCategoryForm.value).subscribe(response => {
            this.router.navigateByUrl('/maintenence-planning/add-dailyairworthinessfromcategory');
