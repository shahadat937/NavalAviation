...
@Component({
  ...
  styleUrls: ['./noticeboard-list.component.sass']
})
export class NoticeBoardListComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private NoticeBoardService: NoticeBoardService,private router: Router,private confirmService: ConfirmService) { }
