...
import {TrainingCrew} from '../../../../src/app/maintenence-planning/models/TrainingCrew'
import {ITrainingCrewPagination, TrainingCrewPagination} from '../../../../src/app/maintenence-planning/models/TrainingCrewPagination'
...
//  getTrainingCrewListByDepartmentNameId( departmentNameId:number,employeeTypeId){
//   return this.http.get<TrainingCrew[]>(this.baseUrl + '/training-crew/get-TrainingCrewListByDepartmentNameId?departmentNameId='+departmentNameId+'&employeeTypeId='+employeeTypeId+'');
//  }
...
//  }
 ...
 traineeAttendance(departmentNameId,officerStatusId){
  return this.http.get<TrainingCrew[]>(this.baseUrl + '/training-crew/get-TrainingCrewPresentListByDepartmentNameId?departmentNameId='+departmentNameId+'&officerStatusId='+officerStatusId+'');
 }
  
 traineeAttendanceList(date,departmentId,officerStatusId,searchText:string){
  return this.http.get<any[]>(this.baseUrl + '/attendence/get-atendanceListByDepartmentNameIdandDate?date='+date+'&departmentNameId='+departmentId+'&officerStatusId='+officerStatusId+'&searchText='+searchText);
 }
 ...
 saveAttendanceList(model: any) {
  return this.http.post(this.baseUrl + '/attendence/save-Attendence', model);
} 
