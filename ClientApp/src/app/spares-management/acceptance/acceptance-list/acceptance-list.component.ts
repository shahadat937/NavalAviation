...
export class AcceptanceListComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'ser', 'itemDetail', 'sftQty','demandDate', 'deliveryDate',/*'acceptanceDocument', */'outerLatterNo', 'actions'];
  ...
  getAcceptances() {
    this.isLoading = true;
    this.AcceptanceService.getAcceptances(this.paging.pageIndex, this.paging.pageSize,this.searchText,this.masterData.sparescategory.spares).subscribe(response => {
