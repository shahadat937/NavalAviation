...
@Component({
  ...
  styleUrls: ["./inventory-details.component.sass"],
})
export class InventoryDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.GetAvailableIssueQtyDetailList(id);
    //this.getItemDetails();
    // this.getItemDetailsForSpares();
  }

  GetAvailableIssueQtyDetailList(itemDetailId) {
    this.ItemDetailService.getAvailableIssueQtyDetailList(itemDetailId).subscribe(
      (res) => {
