...
import {
  IItemStorPagination,
  ItemStorPagination,
} from "../models/ItemStorPagination";
import { ItemStor } from "../models/ItemStor";
import { map } from "rxjs";
import { SelectedModel } from "src/app/core/models/selectedModel";
import { Acceptance } from "../models/Acceptance";
import { AllDocument } from 'src/app/spares-management/models/AllDocument';
@Injectable({
  providedIn: "root",
})
export class ItemStorService {
  ...
  getAllStoreListofDocument(itemStorId) {
    return this.http.get<AllDocument[]>(
      this.baseUrl + '/item-stor/get-allStoreListofDocument?itemStorId=' +itemStorId);
  }
  ...
  partnoFromAcceptanceByDepartmentName(departmentNameId, sparesCategoryId) {
    return this.http.get<SelectedModel[]>(
      this.baseUrl +
        "/acceptance/get-partnoFromAcceptanceByDepartmentNameId?departmentNameId=" +departmentNameId +"&sparesCategoryId=" + sparesCategoryId
    );
  }
