...
// Auto complete
  getSelectedTraineeByPno(pno) {
    ...
    this.PreviousItemStoreService.getSelectedPartNoForSpareParameterRequest(pno,departmentNameId,1).subscribe(
      (response) => {
  ...
  getselectedItemDetails() {
    ...
    this.PreviousItemStoreService.getselectedItemDetails(departmentNameId, this.masterData.sparescategory.spares).subscribe((res) => {
  ...
  getselectedItemCategory() {
    this.PreviousItemStoreService.getSelectedItemCategory(this.masterData.sparescategory.spares).subscribe((res) => {
