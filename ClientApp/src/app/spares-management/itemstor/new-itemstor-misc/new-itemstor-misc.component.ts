...
@Component({
  selector: 'app-new-itemstor-misc',
  templateUrl: './new-itemstor-misc.component.html', 
  styleUrls: ['./new-itemstor-misc.component.sass']
})
export class NewItemStorMiscComponent implements OnInit {
  pageTitle: String;
  destination: String;
  btnText:String;
  ...
  ngOnInit(): void {
    ...
    if (id) {
      this.pageTitle = 'Edit Item Store - Misc';
      ...
      this.pageTitle = 'Create Item Store - Misc';
  ...
  intitializeForm() {
    this.ItemStorForm = this.fb.group({
      ...
      denoId: [],
      departmentNameId: [],
      itemCategoryId:[this.masterData.itemcategory.Misc],
      serviceLifeTypeId:[],
      sparesCategoryId:[],
      endLifeTypeId: [],
      acctStoreId: [],
  ...
  getItemStors() {
    this.isLoading = true;
    this.ItemStorService.getItemStors(this.paging.pageIndex, this.paging.pageSize,this.searchText, this.masterData.itemcategory.Misc).subscribe(response => {
      ...
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(result => {
        ...
        if (result) {
          this.ItemStorService.update(+id,this.ItemStorForm.value).subscribe(response => {
            this.router.navigateByUrl('/spares-management/add-itemstor-misc');
            this.getItemStors();
