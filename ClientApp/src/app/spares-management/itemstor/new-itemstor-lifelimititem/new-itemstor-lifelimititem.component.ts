...
@Component({
  selector: 'app-new-itemstor-lifelimititem',
  templateUrl: './new-itemstor-lifelimititem.component.html',
  styleUrls: ['./new-itemstor-lifelimititem.component.sass'] 
}) 
export class NewItemStorLifeLimitItemComponent implements OnInit {
  pageTitle: String;
  destination: String;
  btnText:String;
  ...
  ngOnInit(): void {
    ...
    if (id) {
      this.pageTitle = 'Edit Item Store - LifeLimit Item';
      ...
      this.pageTitle = 'Create Item Store - LifeLimit Item';
  ...
  intitializeForm() {
    this.ItemStorForm = this.fb.group({
      ...
      denoId: [],
      departmentNameId: [],
      itemCategoryId:[this.masterData.itemcategory.lifeLimitItem],
      serviceLifeTypeId:[],
      sparesCategoryId:[],
      endLifeTypeId: [],
      qtyEntryType:[''],
  ...
  getItemStors() {
    this.isLoading = true;
    this.ItemStorService.getItemStors(this.paging.pageIndex, this.paging.pageSize,this.searchText, this.masterData.itemcategory.lifeLimitItem).subscribe(response => {
      ...
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(result => {
        ...
        if (result) {
          this.ItemStorService.update(+id,this.ItemStorForm.value).subscribe(response => {
            this.router.navigateByUrl('/spares-management/add-itemstor-lifelimititem');
            this.getItemStors();
