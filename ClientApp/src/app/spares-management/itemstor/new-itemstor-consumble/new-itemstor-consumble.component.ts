...
@Component({
  selector: 'app-new-itemstor-consumble',
  templateUrl: './new-itemstor-consumble.component.html',
  styleUrls: ['./new-itemstor-consumble.component.sass']
})
export class NewItemStorConsumbleComponent implements OnInit {
  pageTitle: String;
  destination: String;
  btnText:String;
  ...
  ngOnInit(): void {
    ...
    if (id) {
      this.pageTitle = 'Edit Item Store - Consumble';
      ...
      this.pageTitle = 'Create Item Store - Consumble';
  ...
  intitializeForm() {
    this.ItemStorForm = this.fb.group({
      ...
      denoId: [],
      departmentNameId: [],
      itemCategoryId:[this.masterData.itemcategory.consumble],
      serviceLifeTypeId:[],
      sparesCategoryId:[],
      endLifeTypeId: [],
      acctStoreId: [],
  ...
  getItemStors() {
    this.isLoading = true;
    this.ItemStorService.getItemStors(this.paging.pageIndex, this.paging.pageSize,this.searchText, this.masterData.itemcategory.consumble).subscribe(response => {
      ...
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(result => {
        ...
        if (result) {
          this.ItemStorService.update(+id,this.ItemStorForm.value).subscribe(response => {
            this.router.navigateByUrl('/spares-management/add-itemstor-consumble');
            this.getItemStors();
