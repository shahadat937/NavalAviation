...
@Component({
  selector: 'app-new-itemstor-returnable',
  templateUrl: './new-itemstor-returnable.component.html',
  styleUrls: ['./new-itemstor-returnable.component.sass'] 
})
export class NewItemStorReturnableComponent implements OnInit {
  pageTitle: String;
  destination: String;
  btnText:String;
  ...
  ngOnInit(): void {
    ...
    if (id) {
      this.pageTitle = 'Edit Item Store - Returnable';
      ...
      this.pageTitle = 'Create Item Store - Returnable';
  ...
  intitializeForm() {
    this.ItemStorForm = this.fb.group({
      ...
      denoId: [],
      departmentNameId: [],
      itemCategoryId:[this.masterData.itemcategory.returnable],
      serviceLifeTypeId:[],
      sparesCategoryId:[],
      endLifeTypeId: [],
      acctStoreId: [],
  ...
  getItemStors() {
    this.isLoading = true;
    this.ItemStorService.getItemStors(this.paging.pageIndex, this.paging.pageSize,this.searchText, this.masterData.itemcategory.returnable).subscribe(response => {
      ...
      this.confirmService.confirm('Confirm Update message', 'Are You Sure Update This  Item?').subscribe(result => {
        ...
        if (result) {
          this.ItemStorService.update(+id,this.ItemStorForm.value).subscribe(response => {
            this.router.navigateByUrl('/spares-management/add-itemstor-returnable');
            this.getItemStors();
