...
{
    public class FileUrlResolver : IValueResolver<Demand, DemandDto,  string>
    {
        ...
        {
            if (!string.IsNullOrEmpty(source.DemandLetterNo))
            {

                return _config["ApiUrl"] + source.DemandLetterNo;
            }
