namespace SchoolManagement.Application.DTOs.PreviousItemStore
{
    public class PreviousItemStoreDto : IPreviousItemStoreDto
    {
        ...
        public string? ServisLifeType { get; set; }
        public string? SparesCategory { get; set; }
        public string? EndLifeType { get; set; }
        public string? AcctStore { get; set; }
        public string? OverhawlingType { get; set; }
        public string? RetirmentType { get; set; }
    }
}
