...
{
    public class GetItemStorListByParameterRequestHandler : IRequestHandler<GetItemStorListByParameterRequest, PagedResult<ItemStorDto>>
    {
        ...
        public GetItemStorListByParameterRequestHandler(ISchoolManagementRepository<SchoolManagement.Domain.ItemStor> ItemStorRepository, IMapper mapper)
        {
            _ItemStorRepository = ItemStorRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<ItemStorDto>> Handle(GetItemStorListByParameterRequest request, CancellationToken cancellationToken)
        {
