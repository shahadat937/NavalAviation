...
{
    public class GetItemStorListByDepartmentNameIdRequestHandler : IRequestHandler<GetItemStorListByDepartmentNameIdRequest, PagedResult<ItemStorDto>>
    {
        ...
        public GetItemStorListByDepartmentNameIdRequestHandler(ISchoolManagementRepository<SchoolManagement.Domain.ItemStor> ItemStorRepository, IMapper mapper)
        {
            _ItemStorRepository = ItemStorRepository;
            _mapper = mapper;
        }

        public async Task<PagedResult<ItemStorDto>> Handle(GetItemStorListByDepartmentNameIdRequest request, CancellationToken cancellationToken)
        {
