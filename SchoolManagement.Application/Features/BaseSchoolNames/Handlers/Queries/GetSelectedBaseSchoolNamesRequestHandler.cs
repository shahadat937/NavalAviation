...
{ 
    public class GetSelectedBaseSchoolNamesRequestHandler : IRequestHandler<GetSelectedBaseSchoolNamesRequest, List<SelectedModel>>
    {
        private readonly ISchoolManagementRepository<BaseSchoolName> _SchoolNameRepository;


        public GetSelectedBaseSchoolNamesRequestHandler(ISchoolManagementRepository<BaseSchoolName> SchoolNameRepository)
        {
